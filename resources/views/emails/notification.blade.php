...
@section('content')
            ...
            <tr>
                <td align="center" style="padding-bottom:20px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td
                                style="background:linear-gradient(135deg, #38bdf8, #4f46e5); width:56px; height:56px; border-radius:50%; text-align:center; line-height:56px; font-size:28px; color:white;">
                                {{ $icon }}
                            </td>
                        </tr>
                    </table>
    ...
    {{-- Body --}}
    @isset($body)
        <div style="margin:0 0 24px; font-family:'Inter',sans-serif; font-size:14px; color:#475569; line-height:1.7;">
            {!! $body !!}
        </div>
    @endisset
