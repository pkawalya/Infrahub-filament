...
@section('content')
        ...
        <tr>
            <td align="center" style="padding-bottom:20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td
                            style="background:linear-gradient(135deg, #059669, #10b981); width:56px; height:56px; border-radius:50%; text-align:center; line-height:56px; font-size:28px; color:white;">
                            ✓
                        </td>
                    </tr>
                </table>
    ...
    <p style="margin:0 0 24px; font-size:14px; color:#475569; line-height:1.7;">
        This is a test email from your <strong>InfraHub</strong> platform. If you're reading this, your email system is
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding:10px 0; border-bottom:1px solid #e2e8f0;">
                            <span style="font-size:13px; color:#64748b;">SMTP Host</span>
                        </td>
                    ...
                    <tr>
                        <td style="padding:10px 0; border-bottom:1px solid #e2e8f0;">
                            <span style="font-size:13px; color:#64748b;">Port</span>
                        </td>
                        <td style="padding:10px 0; border-bottom:1px solid #e2e8f0; text-align:right;">
                            <code
                    ...
                    <tr>
                        ...
                        <td style="padding:10px 0; border-bottom:1px solid #e2e8f0; text-align:right;">
                            <span style="font-size:13px; font-weight:600; color:#334155;">{{ $fromAddress }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:10px 0;">
                            <span style="font-size:13px; color:#64748b;">Sent at</span>
                        </td>
                        <td style="padding:10px 0; text-align:right;">
                            <span style="font-size:13px; color:#334155;">{{ $sentAt }}</span>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td
                            ...
                            <span style="color:#ffffff; font-size:14px; font-weight:700;">✓ All Systems Operational</span>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <p style="margin:24px 0 0; font-size:13px; color:#94a3b8; text-align:center; line-height:1.6;">
        ...
        <a href="{{ $settingsUrl }}" style="color:#e8a229; text-decoration:none; font-weight:600;">Admin Panel → Settings →
            Email</a>
    </p>
@endsection