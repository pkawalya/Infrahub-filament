...
@push('styles')
    <style>
        ...
        .mod-stat-card.primary .mod-stat-sub.warning {
            color: #fde68a;
        }

        .mod-stat-card.primary .mod-stat-sub.info {
            color: #93c5fd;
        }
        ...
        .dark .mod-stat-card.primary .mod-stat-label {
            color: rgba(255, 255, 255, .75);
        }
        ...
        .dark .mod-stat-card.primary .mod-stat-value {
            color: white;
        }
            ...
            <div style="display: flex; align-items: flex-start; justify-content: space-between;">
                ...
                @if(!empty($stat['icon_svg']))
                    <div class="mod-stat-icon"
                        style="background: {{ ($stat['primary'] ?? false) ? 'rgba(255,255,255,.15)' : ($stat['icon_bg'] ?? '#f0f9ff') }};">
                        {!! $stat['icon_svg'] !!}
                    </div>
                @endif
            </div>
