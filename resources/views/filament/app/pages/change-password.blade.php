    ...
    <div class="max-w-xl mx-auto">
        ...
        @php
            $bannerConfig = match ($this->reason) {
                'expired' => [
                    ...
                    'message' => 'Your password is over ' . config('security.password.max_age_days', 90) . ' days old. Company security policy requires you to set a new password before continuing.',
                ...
                'admin_forced' => [
                    ...
                    'message' => 'Your administrator has required you to change your password. This may be due to a security incident or routine policy enforcement.',
                ...
                default => [
                    ...
                    'message' => 'Your account was just created. For security, please set a personal password before accessing the platform. Enter the temporary password from your welcome email as your current password.',
                    'bg' => 'bg-warning-50 dark:bg-warning-500/10',
                    'ring' => 'ring-warning-200 dark:ring-warning-500/20',
                    'iconColor' => 'text-warning-600 dark:text-warning-400',
                    'titleColor' => 'text-warning-800 dark:text-warning-200',
        ...
        <div class="mb-6 rounded-xl {{ $bannerConfig['bg'] }} p-4 ring-1 {{ $bannerConfig['ring'] }}">
            <div class="flex gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm {{ $bannerConfig['textColor'] }} mt-1">
        ...
        <div class="mb-6 rounded-lg bg-gray-50 dark:bg-white/5 p-4 text-sm text-gray-600 dark:text-gray-400">
            ...
            <ul class="space-y-1 ml-4 list-disc">
                ...
                <li>Cannot reuse your last {{ config('security.password.prevent_reuse', 5) }} passwords</li>
            </ul>
        </div>
