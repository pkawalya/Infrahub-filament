    ...
    <div>
        ...
        <div class="queue-panel" id="queue-panel">
            ...
            <div class="queue-actions">
                ...
                <button class="btn-sync" onclick="clearAllQueues()"
                    style="background: rgba(239,68,68,0.15); color: #f87171; border-color: rgba(239,68,68,0.2);">
                    🗑 Clear Queue
                </button>
            </div>
            <div style="margin-top: 0.75rem; font-size: 0.72rem; color: #64748b;">
                💡 <strong>Tip:</strong> Press <kbd
                    style="background:rgba(99,102,241,0.15); padding:0.1rem 0.4rem; border-radius:4px; font-size:0.7rem;">Ctrl+Shift+S</kbd>
                on any Create/Edit page to save it offline
            </div>
        </div>
            ...
            <div class="offline-card">
                ...
                <form id="form-diary" onsubmit="return saveDiary(event)">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="work_performed" rows="3"
