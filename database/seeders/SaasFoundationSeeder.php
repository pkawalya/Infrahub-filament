...
class SaasFoundationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $starter = Subscription::updateOrCreate(
            ['slug' => 'starter'],
            [
                'name' => 'Starter',
        ...
        $professional = Subscription::updateOrCreate(
            ['slug' => 'professional'],
            [
                'name' => 'Professional',
                ...
                'max_projects' => 25,
                'max_storage_gb' => 25,
                'included_modules' => ['core', 'cde', 'field_management', 'task_workflow', 'inventory', 'bidding'],
        ...
        $enterprise = Subscription::updateOrCreate(
            ['slug' => 'enterprise'],
            [
                'name' => 'Enterprise',
