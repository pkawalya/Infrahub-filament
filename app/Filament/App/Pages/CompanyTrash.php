...
class CompanyTrash extends Page
{
    ...
    public static function modelRegistry(): array
    {
        return [
            ...
            'quotations' => ['label' => 'Quotations',           'model' => \App\Models\Quotation::class,           'labelField' => 'quotation_number',        'icon' => 'heroicon-o-clipboard-document-list'],
            ...
            'stock_transfers' => ['label' => 'Stock Transfers',      'model' => \App\Models\StockTransfer::class,       'labelField' => 'transfer_number',           'icon' => 'heroicon-o-arrows-right-left'],
